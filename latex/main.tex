...
\begin{document}
    ...
    \subsection*{Results}
    The full report is shown in table~\ref{table:tache_lecture_report}. We can
    see the increase in all values with across the board wavering at least
    around $80\%$. This is a big gain in the classification regards compared to just
    the lecture data due to the increase of data, as we can see that for the
    normal has increased to $411$ entries to support and in the clear has
    increased to $394$ entries.
    ...
    Here is the table for the remaining calculations:
